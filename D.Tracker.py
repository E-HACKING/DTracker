...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
                       ...
                       {Wh}--------------------------------
                       {Wh}| {Gr}D-TRACKER - IP ADDRESS {Wh}|
                       {Wh}|       {Gr}@CODE BY DARK-E     {Wh}|
                       {Wh}--------------------------------
    ...
    stderr.writelines(f"""{Wh}
                   ...
                   {Wh}----------------------------------
                    {Wh}| {Gr}D-TRACKER - PHONE NUMBER {Wh}|
                   {Wh}|        {Gr}@CODE BY DARK-E       {Wh}|
                   {Wh}----------------------------------
    ...
    stderr.writelines(f"""{Wh}
                    ...
                    {Wh}----------------------------------
                    {Wh}|  {Gr}D - SHOW YOUR IP ADDRESS  {Wh}|
                   {Wh}|        {Gr}@CODE BY DARK-E      {Wh}|
                   {Wh}----------------------------------
...
""")
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING TOOL {Ye}D-TRACK !")
else:
